...
from src.data.datasets.gnome import Gnome


@patch('src.data.datasets.gnome.Gnome.check_exists', return_value=True)
@patch('src.data.datasets.gnome.Gnome._load_data', return_value=(["data"], ["targets"]))
...
@patch('src.data.datasets.gnome.Gnome.check_exists', return_value=True)
@patch('src.data.datasets.gnome.Gnome._load_data', return_value=(["1","2","3"], [1,2,3]))
