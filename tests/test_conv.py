...
import torch
from src.models.layers.geo_conv import GeometricConv, GeometricConvConfig
...
class MockGraphSpec:
    num_nodes: int
    num_edges: int  # directed edge count (edge_index.shape[1])
    node_feat_dim: int = 8
    edge_feat_dim: int = 16
    directed: bool = False  # if True, returns symmetric edges (2E)
